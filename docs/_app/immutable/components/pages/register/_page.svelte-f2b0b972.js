import{S as Tr,i as Lr,s as Or,k as a,q as m,a as p,l,m as i,r as c,h as n,c as d,n as t,b as g,D as r,O as Pr,B as ur}from"../../../chunks/index-f0b0ed70.js";function Ir(G){let f,M,A,o,T,q,H,h,w,W,L,$,v,O,Y,J,b,_,K,x,Q,y,X,Z,P,rr,er,I,nr,k,tr,ar,S,lr,U,or,j,B,z,ir,D,N,sr,R,E,pr,dr,mr;return{c(){f=a("h1"),M=m("Registration Form"),A=p(),o=a("form"),T=a("label"),q=m("Name:"),H=p(),h=a("div"),w=a("input"),W=p(),L=a("input"),$=p(),v=a("div"),O=a("label"),Y=m("Gender:"),J=p(),b=a("select"),_=a("option"),K=m("Man"),x=a("option"),Q=m("Woman"),y=a("option"),X=m("Other"),Z=p(),P=a("label"),rr=m("Email:"),er=p(),I=a("input"),nr=p(),k=a("label"),tr=m("Password:"),ar=p(),S=a("input"),lr=p(),U=a("script"),or=m(`function login(){\r
            \r
        ...
        }`),j=p(),B=a("head"),z=a("style"),ir=m(`body {\r
            display: grid;\r
...
\r
        ...
        password += <input type="password" id="password" name="password"/>\r
        console.log(email+' '+ password)\r
        }`),xr.forEach(n),s.forEach(n),j=d(e),B=l(e,"HEAD",{});var yr=i(B);z=l(yr,"STYLE",{});var Er=i(z);ir=c(Er,`body {\r
            display: grid;\r
            place-items: center;\r
            height: 80vh;\r
            margin-top: 10px;\r
...
\r
        ...
        .position-button{\r
         ...
         color: rgb(204,255,204);\r
          cursor: pointer;\r
\r
        }`),Er.forEach(n),yr.forEach(n),D=d(e),N=l(e,"BUTTON",{onclick:!0});var wr=i(N);sr=c(wr,"Save"),wr.forEach(n),R=d(e),E=l(e,"BUTTON",{class:!0});var Nr=i(E);pr=c(Nr,"Login"),Nr.forEach(n),this.h()},h(){t(f,"align","center"),t(T,"for","Name"),t(w,"type","text"),t(w,"id","Name"),t(w,"name","first name"),t(w,"placeholder","Enter your first name"),t(L,"type","text"),t(L,"id","last Name"),t(L,"placeholder","Enter your last name"),t(h,"class","name"),t(O,"for","Gender"),_.__value="man",_.value=_.__value,x.__value="woman",x.value=x.__value,y.__value="other",y.value=y.__value,t(b,"id","gender"),t(b,"name","gender"),t(b,"class","gender-size"),t(v,"class","gender"),t(P,"for","email"),t(I,"type","email"),t(I,"id","email"),t(I,"name","email"),t(k,"for","password"),t(S,"type","password"),t(S,"id","password"),t(S,"name","password"),t(N,"onclick","handleSave()"),t(E,"class","position-button")},m(e,u){g(e,f,u),r(f,M),g(e,A,u),g(e,o,u),r(o,T),r(T,q),r(o,H),r(o,h),r(h,w),r(h,W),r(h,L),r(o,$),r(o,v),r(v,O),r(O,Y),r(v,J),r(v,b),r(b,_),r(_,K),r(b,x),r(x,Q),r(b,y),r(y,X),r(o,Z),r(o,P),r(P,rr),r(o,er),r(o,I),r(o,nr),r(o,k),r(k,tr),r(o,ar),r(o,S),r(o,lr),r(o,U),r(U,or),g(e,j,u),g(e,B,u),r(B,z),r(z,ir),g(e,D,u),g(e,N,u),r(N,sr),g(e,R,u),g(e,E,u),r(E,pr),dr||(mr=Pr(E,"click",G[0]),dr=!0)},p:ur,i:ur,o:ur,d(e){e&&n(f),e&&n(A),e&&n(o),e&&n(j),e&&n(B),e&&n(D),e&&n(N),e&&n(R),e&&n(E),dr=!1,mr()}}}function kr(G){return[()=>window.location.href="http://localhost:5173/login"]}class Br extends Tr{constructor(f){super(),Lr(this,f,kr,Ir,Or,{})}}export{Br as default};
