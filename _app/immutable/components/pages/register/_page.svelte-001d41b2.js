import{S as Tr,i as Lr,s as Or,k as a,q as m,a as p,l,m as i,r as c,h as n,c as d,n as t,b as g,D as r,L as Pr,B as ur}from"../../../chunks/index-219d943c.js";function Ir(G){let f,M,A,o,T,q,H,h,w,W,L,$,v,O,Y,J,b,_,K,x,Q,y,X,Z,P,rr,er,I,nr,k,tr,ar,B,lr,U,or,j,S,z,ir,D,N,sr,R,E,pr,dr,mr;return{c(){f=a("h1"),M=m("Registration Form"),A=p(),o=a("form"),T=a("label"),q=m("Name:"),H=p(),h=a("div"),w=a("input"),W=p(),L=a("input"),$=p(),v=a("div"),O=a("label"),Y=m("Gender:"),J=p(),b=a("select"),_=a("option"),K=m("Man"),x=a("option"),Q=m("Woman"),y=a("option"),X=m("Other"),Z=p(),P=a("label"),rr=m("Email:"),er=p(),I=a("input"),nr=p(),k=a("label"),tr=m("Password:"),ar=p(),B=a("input"),lr=p(),U=a("script"),or=m(`function login(){\r
            \r
